...
import com.helger.ubl25.UBL25NamespaceContext;
...
public final class PhiveRulesUBLHelper
{
  ...
  @NonNull
  public static ValidationExecutorSchematron createXSLT_UBL24 (@NonNull final IReadableResource aRes)
  {
    return PhiveRulesHelper.createXSLT (aRes, UBL24NamespaceContext.getInstance ());
  }

  @NonNull
  public static ValidationExecutorSchematron createXSLT_UBL25 (@NonNull final IReadableResource aRes)
  {
    return PhiveRulesHelper.createXSLT (aRes, UBL25NamespaceContext.getInstance ());
  }
}
